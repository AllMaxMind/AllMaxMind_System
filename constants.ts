...
export const STAGE_CONFIG: Record<AppStage, { title: string; step: number }> = {
  ...
  [AppStage.DIMENSION_SELECTION]: { title: 'Select Dimensions', step: 2 },
  [AppStage.ADAPTIVE_QUESTIONS]: { title: 'Deep Dive', step: 3 },
  [AppStage.BLUEPRINT_PREVIEW]: { title: 'Your Blueprint', step: 4 },
};
