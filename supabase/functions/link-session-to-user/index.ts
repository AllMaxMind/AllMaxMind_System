...
const corsHeaders = {
  ...
  'Access-Control-Allow-Headers': 'authorization, x-client-info, apikey, content-type, x-session-id, x-visitor-id, x-supabase-client-platform, x-supabase-client-version',
